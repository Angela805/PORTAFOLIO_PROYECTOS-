...
// Asegúrate de que 'db_conexion.php' contenga la conexión a la base de datos
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $clave_ingresada = $_POST['clave'] ?? ''; // No se limpia la clave antes de verificarla
    ...
    // Si la preparación falla, se debe manejar el error (no crítico aquí)
    if (!$stmt) {
